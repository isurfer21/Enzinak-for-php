...
# CLASS ------------------------------------
#	Title: Xml Displayer
#	Decription: Will print xml in html.
	...
	function PIHandler($parser, $target, $data)
	{
	  switch (strtolower($target))
	  {
		  case "php":
			  ...
			  // If the parsed document is "trusted", we say it is safe to execute PHP code inside it.  If not, display the code instead.
			  if ($this->trustedFile($this->parser_file[$parser]))
			  {
				  eval($data);
			  }
			  else
...
$file = "Assets\setting\CommandVsImage.xml";
$displayXml = new CXmlDisplayer();
$displayXml->initialize($file);
